// Package config provides configuration management utilities for the Nikan.Developer panel,
...
// GetBaseVersion returns the raw embedded release version of the Nikan.Developer panel
...
// GetName returns the name of the Nikan.Developer application.
func GetName() string {
