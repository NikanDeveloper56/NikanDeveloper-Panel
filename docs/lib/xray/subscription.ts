// Pure builders for Nikan.Developer's subscription server: the subscription URLs plus
...
export function buildJsonSubscription(clients: SubClient[]): string {
  ...
  // Nikan.Developer returns a single object for one client, an array for several.
