...
const REPO_URL = 'https://github.com/NikanDeveloper56/NikanDeveloper-Panel';
    ...
    >
      ...
      >
        <div className="sider-brand">
          <div className="brand-block">
            <span className="brand-text">{railCollapsed ? 'N' : 'Nikan.Developer'}</span>
          </div>
          {!railCollapsed && (
      ...
      >
        <div className="drawer-header">
          <div className="brand-block">
            <span className="drawer-brand">Nikan.Developer</span>
          </div>
